...
<body id="page-top">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb cache">
          ...
          <li class="breadcrumb-item active"> Liste des avenues</li>
       ...
       <div class="mb-3">
          ...
          <div class="card-bod">
                    ...
                    <?php
                    include ('connex.php');
                    $req=$bd-> query ("SELECT * FROM `avenue` INNER JOIN quartier ON avenue.idQuartier=quartier.idQuartier INNER JOIN commune ON quartier .idcommune=commune.idcommune;");
                   ...
                   ?>
                        ...
                        <table class="table table-bordered table-striped table-condensed table-hover" id="dataTable">
                            ...
                            <tbody>
                             ...
                             <p>AJOUTER UNE AVENUE</p>
                             <div class="mb-3">
                                <form action="" method="POST">

                                    <div>
                                      <label>Désignation de l'avenue </label>
                                       <input type="texte" name="Designation">
                                   </div>
                                   <div>
                                    <label>Nom du Chef d'avenue</label>
                                       <input type="texte" name="ChefA">
                                   </div>
                                   <div>
                                    <label>Mot de passe</label>
                                       <input type="texte" name="pwA">
                                   </div>
                                   <div>
                                    <label>Selectionne le quartier</label>
                                       <select name="idQuartier" id="idQuartier" class="idQuartier" required>

                                       <option value="">-- Choisir --</option>

                                    <?php
                                    $req1=$bd->query("SELECT*FROM quartier");
                                    $resultats1=$req1->fetchALL(PDO::FETCH_ASSOC);
                                    foreach ($resultats1 as $ave) {
                                    ?>
                                    <option value="<?php echo $ave['idquartier']; ?>">
                                    <?php echo $ave['DesignationQ']; ?>
                                  </option>
                                   <?php }?>
                                </select>
                                    <div>
 ...
 <!--FIN ZONE DE LISTE DEROULANTE POUR FILTRER -->
    ...
    if ($db->query('INSERT INTO Avenue (Designation,ChefA,pwA,idQuartier)
        VALUES("'.$Designation.'","'.$ChefA.'","'.$pwA.'","'.$idQuartier.'")')) {
